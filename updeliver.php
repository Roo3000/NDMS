...
<html>
    ...
    <body>
       <div class="container">
            <h1><marquee direction="rigth">Deliver Information</marquee> </h1>
        </div>
        <div class="top">
    ...
    <div class="container" style="margin-top:50px">
                ...
                <form  method="post" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">  
                        ...
                        <div class="row">
                            ...
                            <label for="inputnom" class="col-lg-3 col-sm-2 control-label">Deliver's Name:</label>
                            <div class="col-lg-4">
                                <input type="text" name="nom" id="inputnom" value="<?php echo $dnm?>" required>
                            </div>
                            <div class="col-lg-3">
                                <p></p>
                            </div>
                    ...
                    <div class="form-group">  
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="number" value="<?php echo $dnb?>" id="inputnum" required>
                            </div>
                            <div class="col-lg-3">
                                <p></p>
                            </div>
       ...
       if(isset($_POST["formsend"])){
           ...
           if(!empty($name) && start($number, '66')==true)){
               $sql ="UPDATE nexttel.deliver SET pseudo='$name', numero='$number' WHERE did='$did'";
