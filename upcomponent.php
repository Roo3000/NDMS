...
<html>
    ...
    <div class="container" style="margin-top:50px">
                ...
                <form  method="post" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                               <button class="btn-primary" ><a href="handover.php">HANDOVER</a></A></button>
                            </div>
                            <div class="col-lg-3">
                                <p></p>
                            </div>
       ...
       if(isset($_POST["formsend"])){
           ...
           if(!empty($SN)){
               $sql ="UPDATE nexttel.component SET quantity='$quantity',nom='$name',SN='$SN',inform='$inform' WHERE id=$id";
